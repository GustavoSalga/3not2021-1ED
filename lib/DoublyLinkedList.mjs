...
export class DoublyLinkedList {
    ...
    remove(pos) {
        ...
        // 4° caso: remoção intermediária
            ...
            // O nodo anterior precisa apontar para o posterior do removido
            before.next = after
            // o nodo posterior precisa apontar para o anterior do removido
            after.prev = before
        }
        this.#count--
...
let removed = lista.removeHead() // Removação do início
console.log({removed})
console.log(lista.print())
console.log(lista.printReverse())

removed = lista.removeTail() // Removação do início
console.log({removed})
console.log(lista.print())
console.log(lista.printReverse())
